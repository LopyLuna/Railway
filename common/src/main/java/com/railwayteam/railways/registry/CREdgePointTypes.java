...
import com.railwayteam.railways.content.handcart.Handcart;
...
public class CREdgePointTypes {
    ...
    public static final EdgePointType<Handcart> HANDCART = EdgePointType.register(Railways.asResource("handcart"), Handcart::new);
