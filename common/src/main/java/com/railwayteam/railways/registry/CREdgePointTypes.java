...
import com.railwayteam.railways.content.handcar.Handcar;
...
public class CREdgePointTypes {
    ...
    public static final EdgePointType<Handcar> HANDCAR = EdgePointType.register(Railways.asResource("handcar"), Handcar::new);
